...
public class WaterController : MonoBehaviour
{
    ...
    public GerstnerData[] GetDataFromMaterial()
    {
        ...
        {
            GerstnerData[] data = {
                new GerstnerData(material.GetFloat("_Wavelength1"), 1f, material.GetFloat("_Steepness1"),  material.GetVector("_Direction1")),
                new GerstnerData(material.GetFloat("_Wavelength2"), 1f, material.GetFloat("_Steepness2"),  material.GetVector("_Direction2")),
                new GerstnerData(material.GetFloat("_Wavelength3"), 1f, material.GetFloat("_Steepness3"),  material.GetVector("_Direction3")),
            };
